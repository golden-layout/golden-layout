...
### Library
golden-layout is shipped via npm, Use the following command to install it:
`npm i golden-layout`. 
...
After installing the source, you can build and start the api-test app to view the library in action. Use the following commands:
